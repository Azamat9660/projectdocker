...
urlpatterns =[
    ...
    path('profile/',ProfileViewSet.as_view({'get': 'list', 'post': 'create'}), name='movie_list'),
    ...
    path('janre/', JanreViewSet.as_view({'get': 'list', 'post': 'create'}), name='movie_detail'),
    path('janre/<int:pk/', JanreViewSet.as_view({'get': 'retrieve', 'put': 'update',
                                                     'delete': 'destroy'}), name='movie_detail'),


    path('movie/', MovieListViewSet.as_view({'get': 'list', 'post': 'create'}), name='movie_detail'),
    path('movie/<int:pk/',MovieListViewSet.as_view({'get': 'retrieve', 'put': 'update',
                                                     'delete': 'destroy'}), name='movie_detail'),
